...
CShotgun_SpinB::CShotgun_SpinB(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CUi(pGraphic_Device)
{
}

CShotgun_SpinB::CShotgun_SpinB(const CShotgun_SpinB& rhs)
	: CUi(rhs)
{
}

HRESULT CShotgun_SpinB::Initialize_Prototype()
{
...
HRESULT CShotgun_SpinB::Initialize(void* pArg)
{
...
HRESULT CShotgun_SpinB::Initialize_Active()
{
	Set_Texture_Index(0);
	Default_Set_Size();
	Initialize_Set_Scale_Pos_Rotation(NULL);
...
void CShotgun_SpinB::PriorityTick(_float fTimeDelta)
{
	m_pGraphic_Device->SetRenderState(D3DRS_LIGHTING, false);
}

void CShotgun_SpinB::Tick(_float fTimeDelta)
{
...
void CShotgun_SpinB::LateTick(_float fTimeDelta)
{
...
void CShotgun_SpinB::Initialize_Set_Scale_Pos_Rotation(void* pArg)
{
	Set_Ui_Pos(250, -100);
	Set_Divide(1.5f);
...
void CShotgun_SpinB::Initialize_Set_Speed()
{
}

void CShotgun_SpinB::Default_Set_LifeTime()
{
}

void CShotgun_SpinB::Default_Set_Size()
{
	m_UiDesc.m_fSizeX = 2048;
	m_UiDesc.m_fSizeY = 2048;
}

POINT CShotgun_SpinB::Get_Texture_Info()
{
...
_float2 CShotgun_SpinB::Lissajous_Curve(_float _fTimeDelta, _float& _fLissajousTime, _float _fPosX, _float _fPosY, _float _fWitth, _float _fHeight, _float _fLagrangianX, _float _fLagrangianY, _float _fPhaseDelta, _float _fLissajousSpeed)
{
...
HRESULT CShotgun_SpinB::Add_Components(void* pArg)
{
...
HRESULT CShotgun_SpinB::Add_Texture(void* pArg)
{
...
CUi* CShotgun_SpinB::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CShotgun_SpinB* pInstance = new CShotgun_SpinB(pGraphic_Device);

	if (FAILED(pInstance->Initialize(NULL)))
	{
		MSG_BOX(TEXT("Failed to Created : CShotgun_SpinB"));
