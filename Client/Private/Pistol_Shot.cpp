...
CPistol_Shot::CPistol_Shot(const CPistol_Shot& rhs)
	: CUi(rhs)
{
}

HRESULT CPistol_Shot::Initialize_Prototype()
{
...
HRESULT CPistol_Shot::Initialize(void* pArg)
{
...
void CPistol_Shot::PriorityTick(_float fTimeDelta)
{
	m_pGraphic_Device->SetRenderState(D3DRS_LIGHTING, false);
}

void CPistol_Shot::Tick(_float fTimeDelta)
{
...
void CPistol_Shot::LateTick(_float fTimeDelta)
{
...
void CPistol_Shot::Initialize_Set_Speed()
{
}

void CPistol_Shot::Default_Set_LifeTime()
{
}
...
_float2 CPistol_Shot::Lissajous_Curve(_float _fTimeDelta, _float& _fLissajousTime, _float _fPosX, _float _fPosY, _float _fWitth, _float _fHeight, _float _fLagrangianX, _float _fLagrangianY, _float _fPhaseDelta, _float _fLissajousSpeed)
{
...
HRESULT CPistol_Shot::Add_Components(void* pArg)
{
...
HRESULT CPistol_Shot::Add_Texture(void* pArg)
{
	if (FAILED(Add_Component(LEVEL_STATIC, TEXT("Pistol_Shot_Textures")
...
CUi* CPistol_Shot::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CPistol_Shot* pInstance = new CPistol_Shot(pGraphic_Device);

	if (FAILED(pInstance->Initialize(NULL)))
	{
		MSG_BOX(TEXT("Failed to Created : CPistol_Shot"));
