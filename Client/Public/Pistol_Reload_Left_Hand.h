...
class CPistol_Reload_Left_Hand final : public CUi
{
protected:
	CPistol_Reload_Left_Hand(LPDIRECT3DDEVICE9 pGraphic_Device);
	CPistol_Reload_Left_Hand(const CPistol_Reload_Left_Hand& rhs);
	virtual ~CPistol_Reload_Left_Hand() = default;
