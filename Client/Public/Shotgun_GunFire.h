...
class CShotgun_Gunfire final : public CUi
{
protected:
	CShotgun_Gunfire(LPDIRECT3DDEVICE9 pGraphic_Device);
	CShotgun_Gunfire(const CShotgun_Gunfire& rhs);
	virtual ~CShotgun_Gunfire() = default;
...
public:
	static CShotgun_Gunfire* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
