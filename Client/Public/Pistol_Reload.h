...
class CPistol_Reload final : public CUi
{
protected:
	CPistol_Reload(LPDIRECT3DDEVICE9 pGraphic_Device);
	CPistol_Reload(const CPistol_Reload& rhs);
	virtual ~CPistol_Reload() = default;
