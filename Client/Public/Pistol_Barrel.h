...
class CPistol_Barrel final : public CUi
{
protected:
	CPistol_Barrel(LPDIRECT3DDEVICE9 pGraphic_Device);
	CPistol_Barrel(const CPistol_Barrel& rhs);
	virtual ~CPistol_Barrel() = default;
