...
class CShotgun_SpinA final : public CUi
{
protected:
	CShotgun_SpinA(LPDIRECT3DDEVICE9 pGraphic_Device);
	CShotgun_SpinA(const CShotgun_SpinA& rhs);
	virtual ~CShotgun_SpinA() = default;
