...
class CPistol_Gunfire final : public CUi
{
protected:
	CPistol_Gunfire(LPDIRECT3DDEVICE9 pGraphic_Device);
	CPistol_Gunfire(const CPistol_Gunfire& rhs);
	virtual ~CPistol_Gunfire() = default;
...
public:
	static CPistol_Gunfire* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
