...
class CShotgun_Reload final : public CUi
{
protected:
	CShotgun_Reload(LPDIRECT3DDEVICE9 pGraphic_Device);
	CShotgun_Reload(const CShotgun_Reload& rhs);
	virtual ~CShotgun_Reload() = default;
