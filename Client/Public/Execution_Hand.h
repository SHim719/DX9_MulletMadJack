...
class CExecution_Hand final : public CUi
{
protected:
	CExecution_Hand(LPDIRECT3DDEVICE9 pGraphic_Device);
	CExecution_Hand(const CExecution_Hand& rhs);
	virtual ~CExecution_Hand() = default;
