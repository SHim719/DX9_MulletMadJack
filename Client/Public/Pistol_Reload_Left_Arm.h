...
class CPistol_Reload_Left_Arm final : public CUi
{
protected:
	CPistol_Reload_Left_Arm(LPDIRECT3DDEVICE9 pGraphic_Device);
	CPistol_Reload_Left_Arm(const CPistol_Reload_Left_Arm& rhs);
	virtual ~CPistol_Reload_Left_Arm() = default;
