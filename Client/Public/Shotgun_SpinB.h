...
class CShotgun_SpinB final : public CUi
{
protected:
	CShotgun_SpinB(LPDIRECT3DDEVICE9 pGraphic_Device);
	CShotgun_SpinB(const CShotgun_SpinB& rhs);
	virtual ~CShotgun_SpinB() = default;
